...
TEST_CASE("good write and read"){
    ...
    CHECK(notebook1.read(/*page*/0,  /*row*/0,  /*column*/0,  Direction::Vertical,4)=="ABCD");

}

TEST_CASE("bad write"){
    CHECK_THROWS(notebook1.write(/*page*/0,  /*row*/0,  /*column*/20,  Direction::Horizontal,"cpp is fun"));  // cant write over somthing written
...
TEST_CASE("good erase and read"){
    ...
    CHECK(notebook1.read(/*page*/0,  /*row*/0,  /*column*/0,  Direction::Vertical,5)=="~~~~~"); // erased hello world from row 1
    CHECK(notebook1.read(/*page*/0,  /*row*/1,  /*column*/0,  Direction::Vertical,5)=="_~___"); // erased ABCD from column 1
    CHECK(notebook1.read(/*page*/0,  /*row*/2,  /*column*/0,  Direction::Vertical,5)=="_~___"); // erased ABCD from column 1
    CHECK(notebook1.read(/*page*/0,  /*row*/3,  /*column*/0,  Direction::Vertical,5)=="~~~~_"); // erased ABCD from column 1 and the first for places in row 3
    CHECK(notebook1.read(/*page*/0,  /*row*/4,  /*column*/0,  Direction::Vertical,5)=="_~___"); // erased ABCD from column 1
}
...
TEST_CASE("loop1"){
    ...
    for (unsigned int i=0; i<110;i++){
        if(i<=89){
            ...
            CHECK_THROWS(notebook1.write(/*page*/i,  /*row*/i,  /*column*/i,  Direction::Horizontal,"hello world")); // the words become out of bounds or start out of bounds
        }
    }
}
